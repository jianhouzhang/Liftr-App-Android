...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                        ...
                                        if (distanceInMiles < 0.01) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callLiftrButton.setVisibility(View.VISIBLE);
                                                    callLiftrButton.setText("Call A Liftr");
                                                    requestActive = false;
                                                    driverActive = false;
                                            ...
                                            callLiftrButton.setVisibility(View.INVISIBLE);
    ...
    public void callLiftr(View view) {

        Log.i("Info", "Call Liftr");
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callLiftrButton.setText("Cancel Liftr");
                                requestActive = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callLiftrButton = (Button) findViewById(R.id.callLiftrButton);
